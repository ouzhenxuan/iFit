...
extern NSString * const kLeftViewWillDisAppear;
extern NSString * const kLeftViewWillAppear;
extern CGFloat const kLeftWidthScale;
...
/** 设置显示状态
 * @param showType 枚举类型PSDrawerManagerShowType
 */
